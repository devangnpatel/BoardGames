 ...
 * @author devang
 */
public class ChessRealProperties extends ChessProperties {
    
    public static final double PHOTO_SCALE_FACTOR = 0.25;
    public static final double PHOTO_WIDTH = 5184.0;
    public static final double PHOTO_HEIGHT = 3456.0;
    
    private final static int BOARD_MARGIN = 0;
    
    public static final int BOARD_WIDTH  = (int)Math.floor(PHOTO_WIDTH*PHOTO_SCALE_FACTOR);
    public static final int BOARD_HEIGHT = (int)Math.floor(PHOTO_HEIGHT*PHOTO_SCALE_FACTOR);
    
    protected static Direction RED_DIRECTION;   // = Direction.UP;
    protected static Direction BLACK_DIRECTION; // = Direction.DOWN;
    ...
    public static ChessRealProperties init(Direction redDirection, Direction blackDirection)
    {
        ChessRealProperties chessRealProperties = new ChessRealProperties();
