 ...
 * @author devang
 */
public class CheckersClassicProperties extends Properties {
    
    public static final int BOARD_WIDTH  = 400;
    public static final int BOARD_HEIGHT = 400;
    
    private int BOARD_MARGIN = 20;
    ...
    public static final Color RED_PIECE_TEXT_COLOR            = YELLOW;
    public static final Color BLACK_PIECE_TEXT_COLOR          = YELLOW;
    
    public static final Color LIGHT_SPACE_COLOR               = RED.darker();
    public static final Color DARK_SPACE_COLOR                = DARK_GRAY.darker().darker();
    public static final Color HIGHLIGHTED_SPACE_COLOR         = ORANGE;
    public static final Color HIGHLIGHTED_SPACE_BORDER_COLOR  = ORANGE.darker();
    public static final Color HOVERED_OVER_SPACE_COLOR        = PINK.darker();
    public static final Color HOVERED_OVER_SPACE_BORDER_COLOR = ORANGE.darker();
    public static final Color SELECTED_SPACE_COLOR            = YELLOW.darker();
    public static final Color SELECTED_SPACE_BORDER_COLOR     = RED.brighter();
    
    // specific to Classic Checkers . . .
    public  static final Color SPACE_BORDER_COLOR              = YELLOW.darker();
    public  static final Color PIECE_BORDER_COLOR              = YELLOW.darker();
    public  static final Color BOARD_BORDER_COLOR              = YELLOW.darker();
    public  static final Color WINDOW_BACKGROUND_COLOR         = BLACK;
    // . . . specific to Classic Checkers
    ...
    private CheckersClassicProperties() { }
    
    public static CheckersClassicProperties init() { return new CheckersClassicProperties(); }
    ...
    public void set_BOARD_MARGIN(int margin)
    {
        BOARD_MARGIN = margin;
    }
    ...
    /**
     * Gets the direction (up or down, forwards or backwards) that
     * the PlayerColor is assigned 
     * - With theses properties, you can set red to move up, or black to move up
