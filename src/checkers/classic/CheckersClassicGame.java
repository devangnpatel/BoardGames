 ...
 * @author devang
 */
public class CheckersClassicGame extends CheckersGame {
    
    /**
     * A Checkers Game for 2 local human players on same screen
     */
    public CheckersClassicGame()
    {
        super();
    }
     ...
     */
    public static void newClassicCheckersAIGame()
    {
        CheckersClassicGame game = new CheckersClassicGame();
     ...
     * - the properties class map colors to any java.awt.Color in java canvas graphics
     */
    public static void newClassicCheckersLocalGame()
    {
        CheckersClassicGame game = new CheckersClassicGame();
     ...
     */
    public static void newClassicCheckersNetworkGame(PlayerColor color, Client networkClient)
    {
        CheckersClassicGame game = new CheckersClassicGame();
    ...
    {
        gui = new CheckersClassicBoard("Checkers Classic");
    }
    ...
    {
        properties = CheckersClassicProperties.init();
    }
    ...
    {
        String msg = "CheckersClassicGame::initializePlayers() called\n";
               msg+= "instead, call appropriate method instead: local,AI,network...";
        
        String loggerMsg = msg;
        Logger.getLogger(CheckersClassicGame.class.getName()).log(Level.SEVERE,loggerMsg);
        /*
    ...
    protected void initializePlayersLocalGame(CheckersClassicBoard gui)
    {
    ...
    protected void initializePlayersAIGame(CheckersClassicBoard gui)
    {
        ...
        CPUPlayerColor     = CheckersClassicProperties.oppositeColor(humanPlayerColor);
    ...
    protected void initializePlayersNetworkGame(CheckersClassicBoard gui, PlayerColor color, Client networkClient)
    {
        
        PlayerColor localPlayerColor  = color;
        PlayerColor remotePlayerColor = CheckersClassicProperties.oppositeColor(color);
    ...
    {    
        currentPlayerColor = CheckersClassicProperties.INITIAL_PLAYER_COLOR;
    ...
    {
        currentPlayerColor = CheckersClassicProperties.oppositeColor(currentPlayerColor);
    ...
    {
        PlayerColor winnerColor = CheckersClassicProperties.oppositeColor(currentPlayerColor);
