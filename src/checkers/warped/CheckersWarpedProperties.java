 ...
 * @author devang
 */
public class CheckersWarpedProperties extends Properties {
    
    public static final int BOARD_WIDTH  = 400;
    public static final int BOARD_HEIGHT = 400;
    
    private static final int BOARD_MARGIN = 0;
    private static final int BOARD_BORDER = 50;
    ...
    private CheckersWarpedProperties() { }
    
    public static CheckersWarpedProperties init() { return new CheckersWarpedProperties(); }
