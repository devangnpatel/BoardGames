 ...
 * @author devang
 */
public class OthelloOriginalGame extends OthelloGame {
     ...
     */
    public static void newOthelloOriginalAIGame()
    {
        OthelloOriginalGame game = new OthelloOriginalGame();
     ...
     * - the properties class map colors to any java.awt.Color in java canvas graphics
     */
    public static void newOthelloOriginalLocalGame()
    {
        OthelloOriginalGame game = new OthelloOriginalGame();
     ...
     */
    public static void newOthelloOriginalNetworkGame(PlayerColor color, Client networkClient)
    {
        OthelloOriginalGame game = new OthelloOriginalGame();
    ...
    {
        gui = new OthelloOriginalBoard("Original Othello");
    }
    ...
    {
        properties = OthelloOriginalProperties.init();
    }
    ...
    {
        String msg = "OthelloOriginalGame::initializePlayers() called\n";
               msg+= "instead, call appropriate method instead: local,AI,network...";
        
        String loggerMsg = msg;
        Logger.getLogger(OthelloOriginalGame.class.getName()).log(Level.SEVERE,loggerMsg);
        /*
    ...
    protected void initializePlayersAIGame(OthelloGraphicsBoard gui)
    {
        ...
        CPUPlayerColor     = OthelloOriginalProperties.oppositeColor(humanPlayerColor);
    ...
    protected void initializePlayersNetworkGame(OthelloGraphicsBoard gui, PlayerColor color, Client networkClient)
    {
        ...
        PlayerColor remotePlayerColor = OthelloOriginalProperties.oppositeColor(color);
    ...
    {    
        currentPlayerColor = OthelloOriginalProperties.INITIAL_PLAYER_COLOR;
    ...
    {
        currentPlayerColor = OthelloOriginalProperties.oppositeColor(currentPlayerColor);
    ...
    private boolean gameOverWindow(Player player)
    {
        ...
        if (numRedPieces > numBlackPieces)
            gameOverText = "game over: pink wins!";
        else if (numBlackPieces > numRedPieces)
            gameOverText = "game over: blue wins!";
        else
