 ...
 * @author devang
 */
public class OthelloPlayerNetwork extends BoardGamePlayerNetwork {
    
    private OthelloPlayerNetwork(Game game, Client networkClient, PlayerColor color)
    {
     ...
     */
    public static OthelloPlayerNetwork create(Game game, Client networkClient, PlayerColor color)
    {
        return new OthelloPlayerNetwork(game,networkClient,color);
    }
    ...
    public void persistMove(Move move)
    {
        ...
        Logger.getLogger(OthelloPlayerNetwork.class.getName()).log(Level.FINE,loggerMsg);
