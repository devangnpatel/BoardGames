 ...
 * @author devang
 */
public class OthelloProperties extends Properties {
    ...
    public static final Color RED_PIECE_GRAPHICS_COLOR        = MAGENTA;
    public static final Color BLACK_PIECE_GRAPHICS_COLOR      = BLUE;
    ...
    public  static final Color SPACE_COLOR                     = GRAY;
    public  static final Color SPACE_BORDER_COLOR              = BLACK;
    public  static final Color PIECE_BORDER_COLOR              = BLACK;
    public  static final Color BOARD_BORDER_COLOR              = GRAY;
    public  static final Color WINDOW_BACKGROUND_COLOR         = GREEN;
    // . . . specific to Reversi
    
    public static final Color HIGHLIGHTED_SPACE_COLOR         = ORANGE;
    public static final Color HIGHLIGHTED_SPACE_BORDER_COLOR  = RED;
    
    public static final Color HOVERED_OVER_SPACE_COLOR        = LIGHT_GRAY;
    public static final Color HOVERED_OVER_SPACE_BORDER_COLOR = BLACK;
    ...
    private OthelloProperties() { }
    
    public static OthelloProperties init() { return new OthelloProperties(); }
