 ...
 * @author devang
 */
public class OthelloDebugProperties extends Properties {
    public static final int BOARD_WIDTH  = 400;
    public static final int BOARD_HEIGHT = 400;
    
    private int BOARD_MARGIN = 0;
    ...
    // specific to Reversi . . .
    public  static final Color SPACE_COLOR                     = LIGHT_GRAY;
    ...
    public  static final Color WINDOW_BACKGROUND_COLOR         = DARK_GRAY;
    // . . . specific to Reversi
    ...
    private OthelloDebugProperties() { }
    
    public static OthelloDebugProperties init() { return new OthelloDebugProperties(); }
