 ...
 * @author devang
 */
public class OthelloGraphicsSpace extends GraphicsSpace {
    private OthelloGraphicsPiece contents;
    ...
    public void paintBackground(Graphics g)
    {
        ...
        g.setColor(OthelloProperties.SPACE_BORDER_COLOR);
        g.fillRect(applyInset(x*width), applyInset(y*height), width, height);

        // paint plain space
        g.setColor(OthelloProperties.SPACE_COLOR);
     ...
     */
    public OthelloGraphicsSpace(Properties properties, Location location, int width, int height, int boardInset, Color spaceColor)
    {
