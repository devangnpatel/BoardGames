...
public class OthelloGame extends BoardGame {
     ...
     */
    public static void newOthelloAIGame()
    {
     ...
     * - the properties class map colors to any java.awt.Color in java canvas graphics
     */
    public static void newOthelloLocalGame()
    {
        OthelloGame game = new OthelloGame();
     ...
     */
    public static void newOthelloNetworkGame(PlayerColor color, Client networkClient)
    {
        OthelloGame game = new OthelloGame();
    ...
    {
        gui = new OthelloGraphicsBoard("Reversi");
    }
    ...
    {
        properties = OthelloProperties.init();
    }
    ...
    {
        String msg = "OthelloGame::initializePlayers() called\n";
               msg+= "instead, call appropriate method instead: local,AI,network...";
        
        String loggerMsg = msg;
        Logger.getLogger(OthelloGame.class.getName()).log(Level.SEVERE,loggerMsg);
        /*
    ...
    protected void initializePlayersAIGame(OthelloGraphicsBoard gui)
    {
        ...
        CPUPlayerColor     = OthelloProperties.oppositeColor(humanPlayerColor);
    ...
    protected void initializePlayersNetworkGame(OthelloGraphicsBoard gui, PlayerColor color, Client networkClient)
    {
        ...
        PlayerColor remotePlayerColor = OthelloProperties.oppositeColor(color);
    ...
    {    
        currentPlayerColor = OthelloProperties.INITIAL_PLAYER_COLOR;
    ...
    {
        currentPlayerColor = OthelloProperties.oppositeColor(currentPlayerColor);
